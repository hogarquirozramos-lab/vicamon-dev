  ...
  wss.on('connection', ws => {
    ...
    ws.on('message', async raw => {
      ...
      try {
        ...
        // MODIFICADO: Torre con Zodiaco aleatorio sin repetir y acceso para invitados
        if (msg.type === 'challenge_gauntlet') { 
          ...
          // Mezclar los 12 Vicamons Zodiaco aleatoriamente
          ...
          battles.set(bId, { 
            ...
            gauntletTeam: zodiacTeam // Guardamos el orden aquí
          }); 
